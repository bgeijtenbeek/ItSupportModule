...
$resultStartTranscript = Start-MsiTranscript -appName $appName -runningContext $runningContext -uninstall
...
####################################################################################
    ...
    Start-UninstallMsiGUID -appName $appName -appVersion $appVersion -dateStamp $dateStamp -installLogFolder $installLogFolder -msiFileName $msiFileName -customArguments $customArguments -scriptPath $scriptPath
